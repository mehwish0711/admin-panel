...
<div class="modal-body">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <h3 class="text-center mb-4">Restaurant Deals</h3>
                <form method="POST" action="insert_restarurant_deal.php" enctype="multipart/form-data">
    <div class="mb-3">
    ...
    <div class="mb-3">
        <label for="merchant_code" class="form-label">Select Merchant Code</label>
        <select class="form-control" name="merchant_code" id="merchant_code" required>
    ...
    <div class="form-check">
        <input class="form-check-input" type="checkbox" value="1" id="takeaway" name="takeaway">
    ...
    <div class="form-check">
        <input class="form-check-input" type="checkbox" value="1" id="takeaway" name="Online">
        <label class="form-check-label" for="takeaway">
            Online
        </label>
    </div>
