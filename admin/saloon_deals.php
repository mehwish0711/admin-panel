...
<div class="modal-body">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <h3 class="text-center mb-4">Saloon Deals</h3>
                <form method="POST" action="insert_saloon_deals.php" enctype="multipart/form-data">
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <select class="form-control" name="deal_cate" id="deal_cate" required>
            ...
            $sql = "SELECT item FROM category WHERE category_type = 'Saloon' ";
